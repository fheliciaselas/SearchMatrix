...
typedef void (*fn_ptr)(vector <int>,unordered_map< int, unordered_map<int,int > > );
...
void  openAndParseData(char **argv, unordered_map< int, unordered_map <int,int > >  &m1, vector < vector <int > > &matrix ){
...
void searchSequence(vector<int> tosearch, unordered_map< int, unordered_map<int,int > > m1){
...
void searchUnordered(vector<int> tosearch, unordered_map< int, unordered_map<int,int > > m1){
...
void searchMaxMatch(vector<int> tosearch, unordered_map< int, unordered_map<int,int > > m1){
...
void add_function_mappings(unordered_map<string,fn_ptr> &fnMap){
